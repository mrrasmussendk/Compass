...
| `COMPASS_WORKING_DIRECTORY` | File operations directory | `~/vitruvian-workspace` |
...
File operations use a dedicated directory (default: `~/vitruvian-workspace`). Override with `COMPASS_WORKING_DIRECTORY`.
