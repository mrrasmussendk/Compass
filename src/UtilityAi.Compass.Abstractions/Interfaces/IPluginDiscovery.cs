...
/// <summary>
/// Discovers capability modules, sensors, sinks, CLI actions, and workflow modules from a plugin assembly.
...
public interface IPluginDiscovery
{
    ...
    /// <summary>Discovers all <see cref="IWorkflowModule"/> implementations provided by plugins.</summary>
    IEnumerable<IWorkflowModule> DiscoverWorkflowModules() => Enumerable.Empty<IWorkflowModule>();
}
