...
/// <param name="ModuleTypes">Fully qualified names of discovered <see cref="VitruvianAbstractions.Interfaces.ICapabilityModule"/> types.</param>
...
public sealed record PluginManifest(
    ...
    ModuleAccess RequiredPermissions = ModuleAccess.None
);
