...
public sealed class VitruvianCapabilityAttribute : Attribute
{
    ...
    /// <summary>Initializes a new instance of <see cref="VitruvianCapabilityAttribute"/>.</summary>
    ...
    public VitruvianCapabilityAttribute(string domain, string description)
    {
        Domain = domain;
