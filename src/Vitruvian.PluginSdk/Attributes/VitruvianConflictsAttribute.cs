...
public sealed class VitruvianConflictsAttribute : Attribute
{
    ...
    /// <summary>Initializes a new instance of <see cref="VitruvianConflictsAttribute"/>.</summary>
    ...
    public VitruvianConflictsAttribute(string[]? ids = null, GoalTag[]? tags = null) { Ids = ids; Tags = tags; }
}
