...
public sealed class VitruvianCooldownAttribute : Attribute
{
    ...
    /// <summary>Initializes a new instance of <see cref="VitruvianCooldownAttribute"/>.</summary>
    ...
    public VitruvianCooldownAttribute(string keyTemplate, int secondsTtl) { KeyTemplate = keyTemplate; SecondsTtl = secondsTtl; }
}
