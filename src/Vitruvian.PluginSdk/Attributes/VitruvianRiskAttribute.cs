...
public sealed class VitruvianRiskAttribute : Attribute
{
    /// <summary>Gets the risk level (0.0 = no risk, 1.0 = maximum risk).</summary>
    public double Risk { get; }

    /// <summary>Initializes a new instance of <see cref="VitruvianRiskAttribute"/>.</summary>
    /// <param name="risk">The risk level associated with this module's proposals.</param>
    public VitruvianRiskAttribute(double risk) { Risk = risk; }
}
