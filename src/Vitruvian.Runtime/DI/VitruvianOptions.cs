...
/// <summary>
/// Configuration options for Vitruvian DI registration via <see cref="ServiceCollectionExtensions.AddUtilityAiVitruvian"/>.
/// </summary>
public sealed class VitruvianOptions
{
    /// <summary>
    ...
    /// When not set, Vitruvian uses a local <c>appdb/Vitruvian-memory.db</c> file under the app base directory.
    /// </summary>
