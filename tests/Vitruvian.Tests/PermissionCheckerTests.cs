...
public sealed class PermissionCheckerTests
{
    ...
    private sealed class ReadOnlyModule : IVitruvianModule
    {
    ...
    private sealed class WriteModule : IVitruvianModule
    {
    ...
    [RequiresPermission(ModuleAccess.Read)]
    [RequiresPermission(ModuleAccess.Write)]
    private sealed class ReadWriteModule : IVitruvianModule
    {
    ...
    private sealed class NoPermissionModule : IVitruvianModule
    {
